      ...
      <div className="flex gap-2">
        ...
        <div className="relative min-w-[100px]">
          <select
            ...
            className="w-full bg-surface-2 border border-gold/18 rounded-sm pl-2.5 pr-8 py-2.5 text-sm text-ink focus:outline-none focus:border-gold/35 transition-colors cursor-pointer appearance-none"
          >
